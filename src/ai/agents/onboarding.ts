    ...
    createAccount: tool({
      ...
      inputSchema: z.object({
        ...
        siteObjective: z
          ...
          .optional()
          .describe(
            "The user's SEO goals or objectives for their website. Only include if the user volunteers this information."
          ),
      }),
    }),
