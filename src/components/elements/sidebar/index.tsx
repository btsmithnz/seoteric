...
export function Sidebar({
  ...
  return (
    <div
      className={cn(
        "fixed top-[calc(var(--spacing-dashboard-nav)+1px)] z-10 h-[calc(100vh-var(--spacing-dashboard-nav))] w-full overflow-y-auto bg-background md:sticky md:top-[calc(var(--spacing-dashboard-nav)+0.5rem+1px)] md:block md:w-64",
