...
function SidebarProvider({
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, sidebarTop]
  )
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "transition-[width] duration-200 ease-linear relative w-(--sidebar-width) bg-transparent h-[calc(100svh-var(--sidebar-top))]",
